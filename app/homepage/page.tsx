...
const page = () => {
  ...
  const handleLeftButtonClick = () => {
    if (scrollContainerRef.current) {
      ...
      container.scrollLeft -= 100; // Adjust the value based on your swipe preference
    }
  };
  ...
  return (
    <div className='w-full min-h-screen bg-pink-200'>
      ...
      <div className='w-5/6 min-h-screen bg-pink-200 p-6'>
        <div className='flex justify-center items-center w-full p-4'>

          <Inputbox name="Search for a Song/Artist/Album"></Inputbox>
        </div>
